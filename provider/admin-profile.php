    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Providers Profile</li>
        </ol>
        ...
        <form name="directory" method="post">
            ...
            <div class="form-row">
              <div class="col-md-6">
                <div class="form-label-group">
                  ...
                  <label for="firstName">Providers Name</label>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-label-group">
          ...
          <div class="form-group">
            <div class="form-row">
              <div class="col-md-12">
                <div class="form-label-group">
                  <input type="text" id="adminregdate" name="adminregdate"  class="form-control" readonly="true" required="required" value="<?php echo $row['regDate'];?>">
                  <label for="inputPassword">Providers Registration Date</label>
                </div>
              </div>
