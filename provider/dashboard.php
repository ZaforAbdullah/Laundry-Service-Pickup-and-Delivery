...
<head>
  ...
  <title>UNIMAS eLaundry || Dashboard</title>
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-warning o-hidden h-100">
              <div class="card-body">
                ...
                <?php $query1=mysqli_query($con,"Select * from tbllaundryreq where provider= '$lmsaid' and  Status ='0'");
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-success o-hidden h-100">
              <div class="card-body">
                ...
                <?php $query2=mysqli_query($con,"Select * from tbllaundryreq where provider= '$lmsaid' and  Status ='1'");
...
?>
            ...
            <div class="card text-white bg-primary o-hidden h-100">
              <div class="card-body">
                ...
                <?php $query3=mysqli_query($con,"Select * from tbllaundryreq where provider= '$lmsaid' and  Status ='2'");
...
?>
            ...
            <div class="card text-white bg-danger o-hidden h-100">
              <div class="card-body">
                ...
                <?php $query4=mysqli_query($con,"Select * from tbllaundryreq where provider= '$lmsaid' and  Status ='3'");
...
$ret=mysqli_query($con,"select * from tblpricelist where provider= '$lmsaid'");
$cnt=1;
while ($row=mysqli_fetch_array($ret)) {

?>

<h3 style="text-align: center;">Laundry Services Price(Per Unit)</h3>
       <table border="1" class="table table-bordered mg-b-0">
<tr>
    <th>Wash (in kg/unit)</th>
    <td>RM <?php  echo $row['TopWear'];?></td>
  </tr>


   <tr>
    <th>Iron (in kg/unit)</th>
    <td>RM <?php  echo $row['BottomWear'];?></td>
  </tr>

<tr>
    <th>Dry Wash (in kg/unit)</th>
    <td>RM <?php  echo $row['Woolen'];?></td>
  </tr>
