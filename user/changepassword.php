...
$query=mysqli_query($con,"select ID from tbluser where ID='$luid' and   Password='$cpassword'");
$row=mysqli_fetch_array($query);
if($row>0){
$ret=mysqli_query($con,"update tbluser set Password='$newpassword' where ID='$luid'");
