...
if(isset($_POST['register']))
  {
    ...
    $ret=mysqli_query($con, "select Email from tbladmin where Email='$email'");
    $result=mysqli_fetch_array($ret);
    if($result>0){
$msg="This email already associated with another account";
    }
    else{
    $query=mysqli_query($con, "insert into tbladmin(AdminName, UserName, MobileNumber, Email, Password) value('$fname', '$usrname', '$mobno', '$email', '$password' )");
    if ($query) {
...
<head>
  ...
  <title>UNIMAS eLaundry User - Registration</title>
...
<body style="background-image: url(../background.jpg); background-position: center center; background-repeat: no-repeat; background-attachment: absolute; background-size: cover;height: 100vh;">
  ...
  <div class="container">
    <div class="card card-login mx-auto mt-5">
      <div class="card-header">eLaundry || Provider Registration</div>
      <div class="card-body">
    ...
    echo $msg;
        ...
        <form class="form-horizontal" action="" name="login"  method="post">
		  ...
		  <div class="form-group">
            <div class="form-label-group">
              <input type="text" id="usrname" name="usrname" class="form-control"  required="required" >
