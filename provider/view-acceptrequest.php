...
$ret=mysqli_query($con,"select * from tbllaundryreq join tbluser on tbluser.id=tbllaundryreq.UserID where tbllaundryreq.ID='$cid' and tbllaundryreq.Status='1'");
$cnt=1;
...
<tr>
  ...
  <td><?php echo $twqty+$bwqty+$wcqty+$thrqyty;?></td>
    <td></td>
      <td><?php echo $twqty*$twp+$bwqty*$bwp+$wcqty*$wwp;?></td>
</tr>
