<ul class="sidebar navbar-nav">
      ...
      <li class="nav-item dropdown">
        ...
        <a class="dropdown-item" href="accept-request.php">Accept Request</a>
          <a class="dropdown-item" href="inprocess-request.php">Inprocess Request</a>
       ...
       <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
			<a class="dropdown-item" href="add-laundryprice.php">Add Services</a>
            <a class="dropdown-item" href="manage-laundryprice.php">Manage Services</a>
        </div>
      </li>
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="#" id="pagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
